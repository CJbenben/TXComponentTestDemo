...
- (ZJScrollSegmentView *)segmentView {
    if (!_segmentView) {
        ...
        ZJScrollSegmentView *segment = [[ZJScrollSegmentView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, self.segmentStyle.segmentHeight) bgViewFrame:CGRectMake(0, 0, self.bounds.size.width, self.segmentStyle.segmentHeight) segmentStyle:self.segmentStyle delegate:self.delegate titles:self.titlesArray details:nil titleDidClick:^(ZJTitleView *titleView, NSInteger index) {
